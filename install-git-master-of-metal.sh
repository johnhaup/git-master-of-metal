...
curl -fL -o "$GIT_DIR/hooks/pre-push/pre-push-files" "https://raw.githubusercontent.com/johnhaup/git-master-of-metal/master/pre-push/pre-push-files/master/first_prompt.mp3"
