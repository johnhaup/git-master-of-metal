...
curl -fL "$GIT_DIR/hooks/pre-push-files/first_prompt.mp3" "https://raw.githubusercontent.com/johnhaup/git-master-of-metal/master/pre-push-files/first_prompt.mp3"
